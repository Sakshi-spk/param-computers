      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-16 lg:px-8 lg:py-20">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          ...
          {brands.map((brand) => (
            ...
            <div
              key={brand.name}
              className="group flex h-24 items-center justify-center rounded-2xl border border-[#E3E8EE] bg-white px-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#D7E1EF] hover:shadow-lg"
            >

              <img
                src={brand.logo}
                alt={`${brand.name} logo`}
                className="max-h-9 max-w-[110px] object-contain opacity-75 grayscale transition-all duration-300 group-hover:opacity-100 group-hover:grayscale-0"
              />
